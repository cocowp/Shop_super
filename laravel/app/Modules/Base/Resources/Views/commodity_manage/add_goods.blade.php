        ...
        <form class="layui-form">
          <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="username" name="price_hua" required="" lay-verify="required"
                           autocomplete="off" class="layui-input">
                </div>
                <div class="layui-form-mid layui-word-aux">
                    <span class="x-red">*</span>商品划线价格
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="file" id="imgs" name="imgs" required="" lay-verify="required"
                           autocomplete="off" class="layui-input">
                </div>
                <div class="layui-form-mid layui-word-aux">
                    <span class="x-red">*</span>商品最低价格
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input id="L_pass" name="desc" required=""
                  autocomplete="off" class="layui-input">
              </div>
              <div class="layui-form-mid layui-word-aux">
                  描述的尽量详细
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="radio" name="is_status" value="1" title="上架">
                    <input type="radio" name="is_status" value="0" title="下架">
                </div>
            </div>
            <div class="layui-form-item">
                <label for="username" class="layui-form-label">
                ...
                <div class="layui-input-inline">
                    <input type="text" id="username" name="repertory" required="" lay-verify="required"
                           autocomplete="off" class="layui-input">
                </div>
                <div class="layui-form-mid layui-word-aux">
                    <span class="x-red">*</span>商品库存
            ...
            <div class="layui-form-item">
                <label class="layui-form-label">单选框</label>
                <div class="layui-input-block">
                    <input type="radio" name="is_gify" value="1" title="礼物">
                    <input type="radio" name="is_gify" value="0" title="普通">
                </div>
            </div>
            <div class="layui-form-item">
