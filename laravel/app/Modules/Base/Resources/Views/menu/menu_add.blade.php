    ...
    <div class="x-body">
        <form class="layui-form">
          ...
          <div class="layui-form-item">
              ...
              <div class="layui-input-inline">
                  <input type="text" value="" id="url" name="url" required=""
                  autocomplete="off" class="layui-input">
              </div>
              <div class="layui-form-mid layui-word-aux">
                  <span class="x-red">*</span>菜单的路径
              </div>
          </div>
          <div class="layui-form-item">
        ...
        layui.use(['form','layer'], function(){
          ...
          form.on('submit(add)', function(data){
            ...
            //发异步，把数据提交给php
              $.ajax({
                 url: "{{'menu_adddo'}}",
                 data: {parent_id:id,name:name,url:url,status:status,'_token':'{{csrf_token()}}'},
                 dataType: 'json',
                 type: 'post',
                 success:function (e) {
                     if (e.code == 1)
