...
>>>>>>> 2842324b951f15a65470f5a8f55928117238bf34
                </span>
        ...
        <div class="nav">
            ...
            <div class="leftNav">
                <ul>
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="{{ URL::asset('a/images/nav1.png') }}" /></span>
                        ...
                        <div class="zj">
                            ...
                            <div class="zj_r">
                                <a href="#"><img src="{{ URL::asset('a/images/n_img1.jpg') }}" width="236" height="200" /></a>
                                <a href="#"><img src="{{ URL::asset('a/images/n_img2.jpg') }}" width="236" height="200" /></a>
                            </div>
                        </div>
                    </li>
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="{{ URL::asset('a/images/nav2.png') }}" /></span>
                    ...
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="{{ URL::asset('a/images/nav3.png') }}" /></span>
                    ...
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="{{ URL::asset('a/images/nav4.png') }}" /></span>
                    ...
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="{{ URL::asset('a/images/nav5.png') }}" /></span>
                    ...
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="{{ URL::asset('a/images/nav6.png') }}" /></span>
                    ...
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="{{ URL::asset('a/images/nav7.png') }}" /></span>
                    ...
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="{{ URL::asset('a/images/nav8.png') }}" /></span>
                    ...
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="{{ URL::asset('a/images/nav9.png') }}" /></span>
                    ...
                    <li>
                        <div class="fj">
                            <span class="n_img"><span></span><img src="{{ URL::asset('a/images/nav10.png') }}" /></span>
...
<div class="i_bg bg_color">
        ...
        <div class="banner">
            <div class="top_slide_wrap">
                <ul class="slide_box bxslider">
                    <li><img src="{{ URL::asset('a/images/ban1.jpg') }}" width="740" height="401" /></li>
                    <li><img src="{{ URL::asset('a/images/ban1.jpg') }}" width="740" height="401" /></li>
                    <li><img src="{{ URL::asset('a/images/ban1.jpg') }}" width="740" height="401" /></li>
                </ul>
    ...
    <!-- Begin 广告 Begin -->
    <div class="content mar_20">
        <img width="1200" height="110" src="{{ URL::asset('a/images/mban_1.jpg') }}">
    </div>
    <!-- End 广告 End -->
        ...
        <div class="fresh_mid">
            <ul>
                <li>
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/food_1.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">莫斯利安酸奶</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/food_2.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">莫斯利安酸奶</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/food_3.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">莫斯利安酸奶</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/food_4.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">莫斯利安酸奶</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/food_5.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">莫斯利安酸奶</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/food_6.jpg') }}" width="185" height="155" /></a></div>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="fresh_mid">
            <ul>
                <li>
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/make_1.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">美宝莲粉饼</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/make_2.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">美宝莲粉饼</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/make_3.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">美宝莲粉饼</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/make_4.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">美宝莲粉饼</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/make_5.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">美宝莲粉饼</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/make_6.jpg') }}" width="185" height="155" /></a></div>
                </li>
            </ul>
        </div>
    </div>
    <!--End 个人美妆 End-->
    <div class="content mar_20">
        <img src="{{ URL::asset('a/images/mban_1.jpg') }}" width="1200" height="110" />
    </div>
    <!--Begin 母婴玩具 Begin-->
    <div class="i_t mar_10">
        ...
        <div class="fresh_mid">
            <ul>
                <li>
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/baby_1.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">儿童玩具  变形金刚</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/baby_2.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">儿童玩具  变形金刚</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/baby_3.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">儿童玩具  变形金刚</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/baby_4.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">儿童玩具  变形金刚</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/baby_5.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">儿童玩具  变形金刚</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/baby_6.jpg') }}" width="185" height="155" /></a></div>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="fresh_mid">
            <ul>
                <li>
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/home_1.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">品质蓝色沙发</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/home_2.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">品质蓝色沙发</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/home_3.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">品质蓝色沙发</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/home_4.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">品质蓝色沙发</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/home_5.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">品质蓝色沙发</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/home_6.jpg') }}" width="185" height="155" /></a></div>
                </li>
            </ul>
        </div>
    </div>
        ...
        <div class="fresh_mid">
            <ul>
                <li>
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/tel_1.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">乐视高清电视</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/tel_2.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">乐视高清电视</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/tel_3.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">乐视高清电视</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/tel_4.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">乐视高清电视</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/tel_5.jpg') }}" width="185" height="155" /></a></div>
                </li>
                <li>
                    <div class="name"><a href="#">乐视高清电视</a></div>
                    <div class="price">
                    ...
                    <div class="img"><a href="#"><img src="{{ URL::asset('a/images/tel_6.jpg') }}" width="185" height="155" /></a></div>
                </li>
            </ul>
        </div>
    </div>
                    ...
                    <div id="botton-scroll1">
                        <ul class="featureUL">
                            <li class="featureBox">
                                <div class="box">
                                    <div class="imgbg">
                                        <a href="#"><img src="{{ URL::asset('a/images/hot1.jpg') }}" width="160" height="136" /></a>
                                    </div>
                                    <div class="name">
                                        <a href="#">
                                            <h2>德国进口</h2>
                            ...
                            <li class="featureBox">
                                <div class="box">
                                    <div class="imgbg">
                                        <a href="#"><img src="{{ URL::asset('a/images/hot2.jpg') }}" width="160" height="136" /></a>
                                    </div>
                                    <div class="name">
                                        <a href="#">
                                            <h2>iphone 6S</h2>
                            ...
                            <li class="featureBox">
                                <div class="box">
                                    <div class="imgbg">
                                        <a href="#"><img src="{{ URL::asset('a/images/hot3.jpg') }}" width="160" height="136" /></a>
                                    </div>
                                    <div class="name">
                                        <a href="#">
                                            <h2>倩碧特惠组合套装</h2>
                            ...
                            <li class="featureBox">
                                <div class="box">
                                    <div class="imgbg">
                                        <a href="#"><img src="{{ URL::asset('a/images/hot4.jpg') }}" width="160" height="136" /></a>
                                    </div>
                                    <div class="name">
                                        <a href="#">
                                            <h2>品利特级橄榄油</h2>
                            ...
                            <li class="featureBox">
                                <div class="box">
                                    <div class="imgbg">
                                        <a href="#"><img src="{{ URL::asset('a/js/images/hot4.jpg') }}" width="160" height="136" /></a>
                                    </div>
                                    <div class="name">
                                        <a href="#">
                                            <h2>品利特级橄榄油</h2>
