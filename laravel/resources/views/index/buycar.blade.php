    ...
    <div class="i_car">
        ...
        <div class="car_bg">
            ...
            <ul class="cars">
                ...
                <li>
                	<div class="img"><a href="#"><img src="{{ URL::asset('images/car2.jpg') }}" width="58" height="58" /></a></div>
                    <div class="name"><a href="#">香奈儿（Chanel）邂逅活力淡香水50ml</a></div>
                    <div class="price"><font color="#ff4e00">￥399</font> X1</div>
                </li>
            </ul>
...
<div class="i_bg">  
    <div class="content mar_20">
    	<img src="{{ URL::asset('a/images/img1.jpg') }}" />
    </div>
    ...
    <div class="content mar_20">
    	<table border="0" class="car_tab" style="width:1200px; margin-bottom:50px;" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td>
            	<div class="c_s_img"><img src="{{ URL::asset('a/images/c_1.jpg') }}" width="73" height="73" /></div>
          ...
          <tr class="car_tr">
            <td>
            	<div class="c_s_img"><img src="{{ URL::asset('a/images/c_2.jpg') }}" width="73" height="73" /></div>
                Rio 锐澳 水蜜桃味白兰地鸡尾酒（预调酒） 275ml
            </td>
            <td align="center">颜色：灰色</td>
            <td align="center">
          ...
          <tr>
            <td>
            	<div class="c_s_img"><img src="{{ URL::asset('a/images/c_3.jpg') }}" width="73" height="73" /></div>
                Rio 锐澳 水蜜桃味白兰地鸡尾酒（预调酒） 275ml
            </td>
            <td align="center">颜色：灰色</td>
            <td align="center">
          ...
          <tr class="car_tr">
            <td>
            	<div class="c_s_img"><img src="{{ URL::asset('a/images/c_4.jpg') }}" width="73" height="73" /></div>
                Rio 锐澳 水蜜桃味白兰地鸡尾酒（预调酒） 275ml
            </td>
            <td align="center">颜色：灰色</td>
            <td align="center">
          ...
          <tr valign="top" height="150">
          	<td colspan="6" align="right">
            	<a href="#"><img src="{{ URL::asset('a/images/buy1.gif') }}" /></a>&nbsp; &nbsp; <a href="#"><img src="{{ URL::asset('a/images/buy2.gif') }}" /></a>
            </td>
          </tr>
        </table>
